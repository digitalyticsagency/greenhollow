...
.tipcard{ display:flex; gap:10px; margin:7px 10px; padding:10px 11px; border-radius:13px;
  background:var(--g1); border:.5px solid var(--hair); border-left:3px solid var(--txt3); }
.tipcard.p1{ border-left-color:var(--bad); } .tipcard.p2{ border-left-color:var(--warn); }
.tipcard.p3{ border-left-color:var(--acc2); }
.tipn{ width:19px; height:19px; border-radius:50%; background:var(--g2); flex:none;
