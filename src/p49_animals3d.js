...
if(typeof BP !== 'undefined' && Array.isArray(BP) && !BP.some(b=>b.id==='cow_pasture')){
  /* Field names matter here: the list filters on cat==='animal' (singular),
     stocking needs buy:, and the panel reads desc:/tip:. Getting any of
     them wrong makes the blueprint invisible or unusable. */
  BP.push({
    id:'cow_pasture', name:'Dairy pasture', art:'cow_pasture', cat:'animal', kind:'animal',
    w:5, h:4, cost:1400, lvl:4,
    animal:'cow', cap:4, buy:240, good:'milk', per:2, cycle:1, feed:3.0, charm:6,
    desc:'Grazing for up to 4 dairy cows. Milked every day.',
    tip:'The heaviest feeder on the farm and the best daily return. Do not buy stock until the feed store can keep up.',
  });
